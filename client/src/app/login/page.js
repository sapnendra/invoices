      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900"><span className='text-lg sm:text-xl'>Invoice Manager</span> <br /> <span className='text-lg sm:text-3xl text-blue-500'>Meru Technosoft</span></h1>
